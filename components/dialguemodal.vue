                ...
                <div
                    ...
                    <div>
                        ...
                        <div class="mt-2 text-center">
                            <h3 class="text-lg font-medium leading-6 text-gray-800 capitalize dark:text-white"
                                id="modal-title">Inquire about this</h3>
                            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                to inquire about this service, book an appointment
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="mt-5 sm:flex sm:items-center sm:justify-between">
                        ...
                        <div class="sm:flex sm:items-center ">
                            ...
                            <button
                                class="w-full px-4 py-2 mt-2 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-[#fb8500]  rounded-md sm:w-auto sm:mt-0 hover:bg-[#fb8500] focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40">
                                Book an Appointmet
                            </button>
                        </div>
                    </div>
